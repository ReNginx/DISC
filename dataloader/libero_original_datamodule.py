"""
Lightning DataModule for LIBERO Original dataset with HDF5 file loading.
"""
...
class LiberoOriginalDataModule(pl.LightningDataModule):
    """Lightning DataModule for LIBERO Original dataset."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize LiberoOriginalDataModule.
        ...
        self.config = LiberoOriginalDataConfig(
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if self.train_split_file and self.test_split_file:
            ...
            if stage == "fit":
                ...
                self.train_dataset = LiberoOriginalDataset(train_config)
            ...
            self.val_dataset = LiberoOriginalDataset(val_config)
            ...
            full_train_dataset = LiberoOriginalDataset(train_config)
        ...
        if stage == "test" or stage is None:
            ...
            self.test_dataset = LiberoOriginalDataset(test_config)
